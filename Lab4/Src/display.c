...
static DispLine_t txLine[ROWS] = {{{0x80, 0x80}, 0x40, {0}}, {{0x80, 0xC0}, 0x40, {0}}};
static bool updateLine[2] = {false, false};
// I2C transfers
static I2C_Xfer_t DispInit = {&LeafyI2C, 0x7C, (uint8_t *)&txInit, 8, 1};
static I2C_Xfer_t DispLine[ROWS] = {{&LeafyI2C, 0x7C, (uint8_t *)&txLine[0], 19, 1}, {&LeafyI2C, 0x7C, (uint8_t *)&txLine[1], 19, 1}};
// Enable LCD display
...
Page_t GetPage(void) { return openPage; }
static void CallbackTouchEnPress(void) { pressTime = TimeNow(); }
static void CallbackTouchEnRelease(void) {
